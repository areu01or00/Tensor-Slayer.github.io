...
<section class="index-hero">
  <div>
    <h1>Tensor Slayer Research Log</h1>
    <p>Notes from practical experiments in model behavior, interpretability, and binary-level interventions. Short, direct, and reproducible where possible.</p>
  </div>
  <div class="index-panel">
    ...
    <div class="project-link" style="margin-top: 0.8rem;">
...
<section class="index-posts">
  ...
  <ul class="post-list">
    ...
    <li class="post-card">
      ...
      <div>{{ post.excerpt | strip_html | strip_newlines }}</div>
    </li>
    {% endfor %}
  </ul>
</section>
